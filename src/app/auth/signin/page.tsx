...
export default function SignInPage() {
  return (
    <main className="relative min-h-screen bg-[#0a1a0d] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm mx-auto px-6">
        ...
        <div className="bg-green-950/80 border border-green-400/20 rounded-2xl p-8 backdrop-blur-sm">
          <h1 className="font-serif text-3xl text-green-50 mb-1 text-center">Welcome back</h1>
          <p className="text-sm text-green-100/40 text-center mb-8">
          ...
          <p className="text-[11px] text-green-100/25 text-center mt-6 leading-relaxed">
