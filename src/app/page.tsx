...
{"irrigation":"specific village-level advice","fertilizer":"specific advice for this region","pestControl":"pest risks specific to ${weather.humidity}% humidity at ${weather.temp}°C in this area","harvesting":"harvesting advice for this location and season","tips":["hyperlocal tip 1","hyperlocal tip 2","hyperlocal tip 3"]}`
  ...
  try {
    ...
    return NextResponse.json({
      irrigation: `At ${weather.temp}°C in ${locationStr}, irrigate ${cropLabel} early morning (5–7am) every ${weather.temp > 35 ? '2–3' : '4–5'} days. Avoid evening irrigation to reduce fungal risk.`,
      fertilizer: `For ${cropLabel} in ${locationStr}: Apply Urea 50kg/acre this week. With ${weather.humidity}% humidity, DAP absorption is ${weather.humidity > 70 ? 'optimal' : 'reduced — add 10% extra'}.`,
      ...
      harvesting: `${cropLabel} harvest in ${locationStr} is best done in early morning. Check local ${district ?? 'district'} mandi price before deciding timing.`,
      tips: [
