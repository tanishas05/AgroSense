  ...
  return (
    <section className="relative z-10 max-w-6xl mx-auto px-8 py-20">
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-400/10 border border-green-400/20 text-4xl text-green-400 mb-4">
          Core features
        </div>
        <h2 className="font-serif text-4xl text-green-50 mb-3">Everything a farmer needs</h2>
        <p className="text-green-100/40 text-4xl max-w-xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {features.map(({ icon, title, desc, tag }) => (
          ...
          >
            ...
            <h3 className="text-4xl font-semibold text-green-100 mb-2">{title}</h3>
            <p className="text-4xl text-green-100/40 leading-relaxed mb-4">{desc}</p>
      ...
      <div className="text-center mt-10">
        <button
          ...
          className="px-8 py-3.5 text-4xl font-medium text-green-300 border border-green-400/25 rounded-xl hover:bg-green-400/8 hover:border-green-400/40 transition-all"
        >
