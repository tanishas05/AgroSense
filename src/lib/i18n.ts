export const translations = {
  en: {
    ...
    joinFarmers: 'Built for Indian farmers — smarter farming, better harvests.',
    ...
    optimal: 'Optimal',
    aiScans: 'AI scans',
    aiScansLabel: 'AI Disease Scans',
    totalScansRun: 'Total scans run',
    ...
    riskScore: 'AI Farming Risk Score',
    riskSub: 'Village-specific · Updated every hour',
    riskOverall: 'Overall Risk',
    riskCrop: 'Crop Failure Risk',
    riskDisease: 'Disease Probability',
    riskWater: 'Water Shortage Risk',
    riskLow: 'Low',
    riskMed: 'Medium',
    riskHigh: 'High',
    ...
    voiceHint: 'Press mic and speak in Hindi or English',
  ...
  hi: {
    ...
    joinFarmers: 'भारतीय किसानों के लिए — स्मार्ट खेती, बेहतर फसल।',
    ...
    optimal: 'सर्वोत्तम',
    aiScans: 'AI स्कैन',
    aiScansLabel: 'AI रोग स्कैन',
    totalScansRun: 'कुल स्कैन',
    ...
    riskScore: 'AI खेती जोखिम स्कोर',
    riskSub: 'गाँव-विशिष्ट · हर घंटे अपडेट',
    riskOverall: 'कुल जोखिम',
    riskCrop: 'फसल विफलता जोखिम',
    riskDisease: 'रोग संभावना',
    riskWater: 'पानी की कमी',
    riskLow: 'कम',
    riskMed: 'मध्यम',
    riskHigh: 'अधिक',
    ...
    voiceHint: 'माइक दबाएं और हिंदी या अंग्रेज़ी में बोलें',
