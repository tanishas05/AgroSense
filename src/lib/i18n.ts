export const translations = {
  en: {
    ...
    weatherAlertsDesc: 'Rain and heatwave warnings',
    ...
    riskSub: 'Weather-based · Updates on page load',
  ...
  hi: {
    ...
    weatherAlertsDesc: 'बारिश और गर्मी की चेतावनी',
    ...
    riskSub: 'मौसम-आधारित · पेज लोड पर अपडेट',
